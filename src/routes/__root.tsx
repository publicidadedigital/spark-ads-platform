...
const criticalCss = `
  *,::before,::after{box-sizing:border-box;border-color:#1f2937}html,body,#root{min-height:100%;margin:0}body{background:#020617;color:#f8fafc;font-family:Inter,system-ui,sans-serif;-webkit-font-smoothing:antialiased}a{color:inherit;text-decoration:none}img{display:block;max-width:100%;height:auto}button,input,textarea,select{font:inherit}
  ...
  input,textarea{border:1px solid #1e293b;background:transparent;color:#f8fafc;border-radius:.5rem;padding:.5rem .75rem;width:100%;outline:none}input:focus,textarea:focus{box-shadow:0 0 0 1px #2563eb}.inline-flex{align-items:center;justify-content:center}
  .app-shell-grid{display:grid;grid-template-columns:240px minmax(0,1fr);gap:1.5rem}.app-sidebar{display:block}.app-mobile-menu{display:none}.dashboard-page{width:100%;max-width:none}.dashboard-stat-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:1rem}.dashboard-earnings-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1rem}.dashboard-stat-grid>*,.dashboard-earnings-grid>*{min-width:0}
  @media (max-width:767px){.app-shell-grid{grid-template-columns:1fr}.app-sidebar{display:none}.app-mobile-menu{display:inline-flex}.dashboard-stat-grid,.dashboard-earnings-grid{grid-template-columns:1fr}}
  @media (min-width:768px) and (max-width:1023px){.dashboard-stat-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.dashboard-earnings-grid{grid-template-columns:repeat(3,minmax(0,1fr))}}
  ...
  @media (min-width:1024px){.lg\:grid-cols-4{grid-template-columns:repeat(4,minmax(0,1fr))}.lg\:grid-cols-\[1\.4fr_1fr_1fr\]{grid-template-columns:1.4fr 1fr 1fr}.lg\:grid-cols-\[1fr_420px_250px\]{grid-template-columns:1fr 420px 250px}}
  @media (min-width:1280px){.xl\:grid-cols-5{grid-template-columns:repeat(5,minmax(0,1fr))}.xl\:grid-cols-6{grid-template-columns:repeat(6,minmax(0,1fr))}.xl\:grid-cols-\[minmax\(0\,1fr\)_304px\]{grid-template-columns:minmax(0,1fr) 304px}.xl\:grid-cols-\[minmax\(0\,1fr\)_330px\]{grid-template-columns:minmax(0,1fr) 330px}}
`;
