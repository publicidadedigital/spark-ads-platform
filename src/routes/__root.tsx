...
const criticalCss = `
  *,::before,::after{box-sizing:border-box;border-color:#1f2937}html,body,#root{min-height:100%;width:100%;margin:0;overflow-x:hidden}body{background:#020617;color:#f8fafc;font-family:Inter,system-ui,sans-serif;-webkit-font-smoothing:antialiased}a{color:inherit;text-decoration:none}img,video,canvas,svg{display:block;max-width:100%;height:auto}button,input,textarea,select{font:inherit;min-width:0}
  ...
  .transition,.transition-colors{transition:all .15s ease}.cursor-pointer{cursor:pointer}.hover\:opacity-90:hover{opacity:.9}.hover\:underline:hover{text-decoration:underline}.hover\:bg-card:hover{background:#0f172a}.hover\:text-foreground:hover{color:#f8fafc}input,textarea{border:1px solid #1e293b;background:transparent;color:#f8fafc;border-radius:.5rem;padding:.5rem .75rem;width:100%;outline:none}input:focus,textarea:focus{box-shadow:0 0 0 1px #2563eb}
  .app-shell-grid{display:grid;grid-template-columns:240px minmax(0,1fr);gap:1.5rem}.app-shell-grid>*,.dashboard-page>*,main>*{min-width:0}.app-sidebar{display:block}.app-mobile-menu{display:none}.dashboard-page{width:100%;max-width:none}.dashboard-stat-grid,.dashboard-earnings-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(230px,1fr));gap:1rem}.dashboard-stat-grid>*,.dashboard-earnings-grid>*{min-width:0}.line-clamp-2{display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2;overflow:hidden}
  @media (max-width:1180px){.app-shell-grid,.md\:grid-cols-\[240px_1fr\]{grid-template-columns:1fr!important}.app-sidebar{display:none!important}.app-mobile-menu{display:inline-flex!important}.grid[class*="xl:grid-cols-[minmax(0,1fr)_330px]"],.grid[class*="xl:grid-cols-[minmax(0,1fr)_304px]"],.grid[class*="lg:grid-cols-[1fr_420px_250px]"],.grid[class*="lg:grid-cols-[1.4fr_1fr_1fr]"]{grid-template-columns:1fr!important}}
  @media (max-width:920px){.app-container{max-width:calc(100vw - 24px)}.md\:grid-cols-2,.md\:grid-cols-3,.md\:grid-cols-4,.dashboard-stat-grid,.dashboard-earnings-grid{grid-template-columns:1fr!important}.flex.lg\:flex-row,.flex.md\:flex-row{flex-direction:column!important;align-items:stretch!important}.grid[class*="xl:grid-cols-[minmax(220px,1fr)_minmax(360px,420px)_minmax(190px,250px)]"]{grid-template-columns:1fr!important}}
  @media (max-width:640px){.app-container{max-width:calc(100vw - 16px)}.p-8{padding:1.25rem!important}.p-6{padding:1rem!important}.p-5{padding:.875rem!important}.text-3xl{font-size:1.55rem!important;line-height:2rem!important}.text-2xl{font-size:1.35rem!important;line-height:1.8rem!important}.text-xl{font-size:1.1rem!important;line-height:1.55rem!important}.sm\:grid-cols-2,.sm\:grid-cols-3,.xl\:grid-cols-5,.xl\:grid-cols-6,.grid[class*="xl:grid-cols-5"],.grid[class*="xl:grid-cols-6"]{grid-template-columns:1fr!important}.min-w-\[820px\]{min-width:680px!important}}
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Viralink" },
      { name: "description", content: "Compartilhe campanhas, monetize sua influência e construa renda recorrente com a plataforma Aurum." },
      { property: "og:title", content: "Viralink" },
      { property: "og:description", content: "Compartilhe campanhas, monetize sua influência e construa renda recorrente com a plataforma Aurum." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Viralink" },
      { name: "twitter:description", content: "Compartilhe campanhas, monetize sua influência e construa renda recorrente com a plataforma Aurum." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/ulBxfcKmCCcNJ6GptBSndypyxnU2/social-images/social-1779283646556-photo_2026-05-19_17.34.19.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/ulBxfcKmCCcNJ6GptBSndypyxnU2/social-images/social-1779283646556-photo_2026-05-19_17.34.19.webp" },
    ],
