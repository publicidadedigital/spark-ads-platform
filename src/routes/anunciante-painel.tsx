...
import { LayoutDashboard, Megaphone, PlusCircle, LogOut, Menu, UserCircle } from "lucide-react";
...
const nav = [
  ...
  { to: "/anunciante-painel/nova-campanha", label: "Nova Campanha", icon: PlusCircle },
  { to: "/anunciante-painel/campanhas", label: "Campanhas", icon: Megaphone },
  { to: "/anunciante-perfil", label: "Meu Perfil", icon: UserCircle },
];
