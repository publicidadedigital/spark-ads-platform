...
import { ArrowLeft, Clock, ShieldCheck, XCircle, ExternalLink, Users, TrendingUp } from "lucide-react";
    ...
    (async () => {
      const [{ data: c }, { data: shares }] = await Promise.all([
        ...
        supabase
          ...
          .select("id,shared_link,status,motivo_rejeicao,created_at,social_handle,instagram_usado,detected_followers,profile:user_id(nome,instagram,avatar_url,seguidores_instagram)")
