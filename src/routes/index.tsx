    ...
    <header className="border-b border-border/50 backdrop-blur-md sticky top-0 z-50 bg-background/70">
      <div className="container mx-auto flex items-center justify-between px-4 py-4">
        ...
        <div className="flex items-center gap-2">
          <a href="https://www.instagram.com/socialviralhub_" target="_blank" rel="noreferrer" className="flex items-center justify-center h-8 w-8 rounded-full text-pink-300 hover:bg-pink-500/15 transition" title="@socialviralhub_">
...
function Footer() {
  ...
  return (
    <footer className="border-t border-border/50 mt-12">
      <div className="container mx-auto px-4 py-8 space-y-4 text-center text-xs text-muted-foreground">
        <div className="flex items-center justify-center gap-3">
          <a
            href="https://www.instagram.com/socialviralhub_"
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-2 rounded-full border border-pink-400/30 bg-pink-500/10 px-4 py-1.5 text-xs text-pink-300 hover:bg-pink-500/20 transition"
          >
