...
export const Route = createFileRoute("/legal/bonificacao")({ component: () => (
  <div className="space-y-3">
    ...
    <ul className="list-disc pl-5 space-y-2">
      ...
      <li>Indicação direta (Nível 1): 20%. Níveis 2 a 5: 5% por nível, sobre entrada de novos pacotes ($70, $130, $310, $1010).</li>
      <li>Mensalidade recorrente de $130 paga a mesma estrutura 20% / 5×4%.</li>
