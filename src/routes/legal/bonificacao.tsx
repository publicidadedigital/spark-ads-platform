...
export const Route = createFileRoute("/legal/bonificacao")({ component: () => (
  <div className="space-y-3">
    ...
    <ul className="list-disc pl-5 space-y-2">
      ...
      <li>Indicação direta (Nível 1): 20%. Níveis 2 a 5: 5% por nível, sobre entrada de novos pacotes (R$300, R$600, R$1200).</li>
      <li>Mensalidade recorrente de R$120 paga a mesma estrutura 20% / 5×4%.</li>
